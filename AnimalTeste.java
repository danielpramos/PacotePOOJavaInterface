...
public class AnimalTeste 
{
		public static void main(String[] args) 
		{
			...
			Cachorro animal1 = new Cachorro("Pérola","1","latir","correr");
			Cavalo animal2 = new Cavalo("Pangare","2","relinchar","correr");
			Preguica animal3 = new Preguica("Preguissinha","3","guinchar","subir em árvores");
